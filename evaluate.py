...
adjusted_low = I_low_adjust_3 * R_low
...
saver = tf.train.Saver(var_list = var_Decom_I + var_Decom_C + var_adjust +bn_moving_vars + var_Decom_Z)
checkpoint_dir = './checkpoint/pretrained/'
...
for idx in range(len(eval_low_data)):
    ...
    save_images(os.path.join(sample_dir, '%s.png' % (name)),
